    ...
    <el-container>
      ...
      <template v-if="items.length">
        <el-scrollbar height="650px">
          <el-container v-for="item in items">
...
export default {
  ...
  beforeMount() {
    axios({
      method: "GET",
      // url: "http://localhost:8080/article/countnum"
      url: "http://49.232.144.53/article/countnum"
    }).then(res => {
  ...
  mounted() {
    ...
    axios({
      method: "GET",
      // url: "http://localhost:8080/article/mainlist",
      url: "http://49.232.144.53:8080/article/mainlist",
      params: params
    }).then(res => {
      if (res.data.code == 200) {
